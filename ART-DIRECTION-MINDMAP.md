...
```mermaid
mindmap
  root((ALLUSIONS TOO GRANDEUR))
    CONFIRMED
      Greg's art is the foundation
        Not decoration added afterward
        Preserve originals read-only
        Derive game-ready assets reproducibly
      Biopunk apocalypse
        Industrial corpse
        Biology reclaiming machinery
        Contamination carries colour
        Nothing clean or uniform
      Tone
        Horror and comedy share the frame
        Satire targets institutions and power
        Gore is excessive specific and darkly funny
      Starting visual journey
        Captured below ground
        Escape the facility
        Enter the derby
        Free surveilled territory
      Black Mirror
        MAP is the likely home page
        The player begins inside surveillance
        Freed places reveal trustworthy INDEX records
        Occult corporate bounty platform watches back
      Combat camera
        First person begins heavy physical and difficult
        Third person is earned
        Third person becomes expressive and combo oriented
    WORKING ORIGINAL RULES
      Palette
        Bone and nicotine
        Dried blood and oxidised iron
        Bruise purple and fungal green
        Tar black
      Surface language
        Rust bloom
        Weld scar
        Biological stain
        Fungal growth
        Wet where dry is expected
      Readability
        Silhouette and value before saturation
        Live data remains clean
        Texture and history sit beneath information
      Seamlessness
        Interfaces are operated objects
        Movement replaces hard cuts
        Inspection uses physical handling
      Replacement discipline
        Provisional work uses final sockets and scale
        Authored replacement is a swap not a rewrite
        Every temporary asset states its replacement path
    GREG SOURCE MATERIAL
      Art Collections catalogue
        43 catalogued source images
        Body sheets
        Interface plates
        Wire collages
      Authored title material
        Room composite
        Inverted attack composite
      Authored footage
        Intro
        Mandala
      Future drops
        ...
        Photography
        Symbols and handwriting
        Character and clothing designs
        Surface scans
        Audio and voice
    PROVISIONAL OR VERIFY
      Bone Yard environment
        Built for superseded toybox brief
        Regrime or replace
      Scrap skiff
        Built for superseded toybox brief
        Preserve rig contract while replacing appearance
      Procedural visuals
        Prove behavior
        Await authored surface and silhouette passes
      Generated audio
        Temporary timing reference
        Await sound identity
      Unverified provenance
        Brand exports
        Roadmap illustration
        polarity.webp
        Do not classify as Greg-authored without evidence
    OPEN FOR GREG
      Which source works become key art
      Final character faces and body proportions
      Final jester silhouette and humiliation register
      Facility architectural era
      Weapon manufacturing language
      Exact occult corporate symbols
      Final page-transition movement
      Music voice and signature sound palette
      Horror comedy balance by scene
```
...
```mermaid
mindmap
  root((VISUAL DISCIPLINES))
    Interface
      CONFIRMED
        Black Mirror is cracked reflective glass
        MAP leads because territory is surveilled
        INDEX knowledge is earned through liberation
        Different corners have different bodily jobs
      WORKING
        CellOutz product grammar
        Chassis-owned page rails
        Photocopy grime and misregistration
        Live data above texture
      OPEN
        Shutter versus corruption versus occult carousel
        Final cursor hand and icon set
    Characters
      CONFIRMED
        Bodies retain injury replacement and history
        Silhouette must survive first and third person
      WORKING
        Specific anatomy instead of generic gore decals
        Power becomes visible through body change
      OPEN
        Final face language
        Species and mutation shape families
        Hero and rival authored designs
    Clothing
      CONFIRMED
        Forced humiliating jester gimp outfit
        Poofy cuffs and gloves remain visible in first person
        Costume belongs to elite control
      WORKING
        Black wine fabric
        Bone and blood cuffs
        Restraint hardware bells locked ruff
      OPEN
        Horror comedy ratio
        Exact cut materials and ornament
        Progression and damage variants
    Anatomy
      CONFIRMED
        Organs bones wounds and replacements are interface
        Smoking affects the persistent lungs
        Dismemberment is zone specific
      WORKING
        Wet tissue against clinical registration
        X-ray readability before decorative gore
        Shallow volumetric organ views expand into 3D
      OPEN
        Final organ model style
        Realism versus stylisation boundary
        Authored wound library
    Environments
      CONFIRMED
        Underground facility first
        Escape route then derby
        Ashbloom is overgrown irradiated infrastructure
      WORKING
        Long punishing sightlines above ground
        Cramped oppressive authored routes below ground
        Contamination is material not paint
      OPEN
        Facility age and original purpose
        Regional architecture families
        Shadow-realm appearance
    Vehicles
      CONFIRMED
        Derby vehicles show violence and persistent damage
        Cars look grown into rather than toy-like
      WORKING
        Exposed mechanism
        Grafted organic parts
        Bone sinew and fungal wheel wells
      OPEN
        Replacement body designs
        Manufacturer and faction silhouettes
        Final cockpit ornament
    Weapons
      CONFIRMED
        Every weapon is physically held inspected and aimed
        First-person handling is heavy and challenging
        Third-person play earns expressive combinations
      WORKING
        Wear mechanism and anatomy remain readable
        Customisation happens on the weapon
      OPEN
        Manufacturing language by faction
        Final silhouettes materials and animations
        Gun and melee progression balance
    Occult technology
      CONFIRMED
        Surveillance company is openly occult and satirically evil
        Black Mirror is a security instrument and cursed mirror
        Corporate bounties jobs and territory are connected
      WORKING
        Ritual diagrams function as controls
        Bureaucratic forms and sigils share one surface
        Technology looks back at its operator
      OPEN
        Company name seal and liturgy
        Which symbols are original canon
        Boundary between machinery and entity
    Animation
      CONFIRMED
        Movement replaces cuts
        Hands and forearms enter from believable body positions
        Objects use authored handling rather than one generic flourish
      WORKING
        Weight anticipation contact recovery
        Breathing wrist drift and material response
        Camera travel preserves the physical subject
      OPEN
        Final transition motion
        Animation exaggeration ceiling
        Signature locomotion for factions
    Lighting
      CONFIRMED
        The screen and lighter illuminate the body and world
        Daylight suppresses artificial glare
        Darkness is a mechanical risk
      WORKING
        Warm contaminated practicals
        Screen emission reflects page and battery state
        Saturation signals contamination or danger
      OPEN
        Facility baseline exposure
        Storm and shadow-realm extremes
        Final accessibility range
    Sound
      CONFIRMED
        Physical actions require material sound
        Page movement should use corruption rather than a generic UI beep
      WORKING
        Digital tearing
        Detuned data chatter
        Cracked-glass resonance
        Mechanism under electronic failure
      OPEN
        Musical language
        Corporate voice and station IDs
        Greg voice-processing rules
        Final transition mix and loudness
    Cinematography
      CONFIRMED
        First person begins uncomfortably close and physical
        Third person is an earned abstract view
        Transitions travel instead of teleporting
      WORKING
        Wide restrained fisheye
        Interfaces remain sharp while the world bows
        Damage and glass remain in the frame
      OPEN
        Unlock beat for third person
        Combat camera distance and aggression
        Cutscene authorship versus player control
```
...
```mermaid
flowchart LR
  A[Greg source artwork] --> B[Read-only source collection]
  B --> C[art_pipeline.py]
  C --> D[body sheets]
  C --> E[interface and map plates]
  C --> F[Wire collages]
  D --> G[ArtSet body contract]
  E --> H[ArtSet plate contract]
  F --> I[ArtSet wire contract]
  G --> J[world materials]
  G --> K[hunter surfaces]
  G --> L[particle portraits]
  H --> M[Black Mirror and HUD grime]
  H --> N[Living Map world plates]
  I --> O[Wire surfaces]
  I --> P[cold-open collage]

  Q[Greg title images] --> R[splash_backdrop.py]
  R --> S[stable room and invert paths]
  S --> T[cold-open shader and screen]

  U[Greg footage] --> V[derive_video.py]
  V --> W[Ogg Theora clips]
  W --> X[cold open and in-world playback]

  Y[Greg models and textures] --> Z[inbox asset folder]
  Z --> AA[scale material and socket audit]
  AA --> AB[stable GLB or texture path]
  AB --> AC[existing gameplay systems]

  AD[Greg sound and voice] --> AE[source and rights note]
  AE --> AF[normalise edit and preserve original]
  AF --> AG[stable event name and audio bus]
  AG --> AH[existing actions and interface timing]
```
