...
Append-only. One line per entry. Read it before every slice; answer NEEDs to
your lane first. Rules: `DESIGN/SWARM.md`.

Entry types:
- `CLAIM <lane> <what> <files>`
- `DONE <lane> <what> <commit>`
- `NEED <from> -> <to>: <what>`
- `BROKE <lane> <test> <commit>`
